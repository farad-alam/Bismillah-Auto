# 🚗 Bismillah Auto – Local Business Website
...
- **SEO Optimization** with `react-helmet-async` & `next-sitemap`
...
*(Add screenshots of homepage, service page, and product section here)*
...
> 💡 This project demonstrates building a **real-world, SEO-ready, high-performance business website** with Next.js and modern web technologies.
