...
export default function Hero() {
  return (
    <section 
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4)), url('https://images.pexels.com/photos/3689532/pexels-photo-3689532.jpeg?auto=compress&cs=tinysrgb&w=1920')`
      }}
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="text-[#F97316] block mt-2">Motolock GPS Tracker in Chapainawabganj</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
            চাঁপাইনবাবগঞ্জের সেরা Motolock GPS ট্র্যাকার সেবা। 
            Real-time tracking, engine lock, anti-theft protection দিয়ে আপনার বাইকের নিরাপত্তা নিশ্চিত করুন।
          </p>
